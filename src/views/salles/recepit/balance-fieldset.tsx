...
export const BalanceFieldset = () => {
  return (
    <>
      ...
      <div className="mt-2 flex w-fit items-center justify-center gap-6 rounded-xl border-b-4 border-green-700 bg-green-400 p-4 shadow-sm dark:bg-gradient-to-tr dark:from-green-300 dark:to-green-500">
